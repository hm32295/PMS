...
import { getAllTasks, getDataProject } from "../../../../interfaces/interface"

export default function ViewData ({setView ,data}:{ setView: any,data:getAllTasks}){
        ...
        <div className='d-flex flex-column align-items-end gap-2'>
          ...
          <table className="table  rounded-3  w-100 bg-white ">
            ...
            <tbody>
              ...
              <tr>
                <td>modification Date</td>
                <td>{`${data.employee?.isVerified ?"done" : "in progress"}`}</td>
              </tr>
